...
export default function Accordion({ id, title, body, isOpen, setIsOpen }) {
  return (
    <div className='w-full lg:px-[25px] px-[15px] lg:py-[13px] py-[8px] rounded-[32px] bg-white/[.6]'>
        ...
        <div className='lg:ml-[4.59rem] ml-[3.5rem] pb-2 transition ease-in duration-300'>
